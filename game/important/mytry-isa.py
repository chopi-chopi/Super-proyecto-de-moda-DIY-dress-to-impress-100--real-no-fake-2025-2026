...
def start_screen():
    ...
    title_surface = font.render("KISS KISS FALL IN LOVE", True, settings.PINK)
...
def cargar_juego():
    ...
    while running and current_screen == "cargar_juego":
        ...
        texto_rect = texto_render.get_rect(topleft=(605, 240))
...
def opciones():
    while running and current_screen == "opciones":
        ...
        screen.fill("lightblue")
        screen.blit(font.render("opciones", True, WHITE), (450,600))
        pygame.display.flip()
