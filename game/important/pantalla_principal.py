...
def start_screen():
    ...
    NUEVO_JUEGO = settings.BOTONES(None, (640, 250), "NUEVO JUEGO", settings.fonts, PINK, LIGHT_GREEN)
    CARGAR_JUEGO = settings.BOTONES(None, (640, 320), "CARGAR JUEGO", settings.fonts, PINK, LIGHT_GREEN)
    OPCIONES = settings.BOTONES(None, (640, 390), "OPCIONES", settings.fonts, PINK, LIGHT_GREEN)
